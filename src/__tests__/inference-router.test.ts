...
describe("DEFAULT_MODEL_STRATEGY_CONFIG", () => {
  it("has sensible defaults", () => {
    expect(DEFAULT_MODEL_STRATEGY_CONFIG.inferenceModel).toBe("gemma-local");
    expect(DEFAULT_MODEL_STRATEGY_CONFIG.lowComputeModel).toBe("gemma-local");
    expect(DEFAULT_MODEL_STRATEGY_CONFIG.criticalModel).toBe("gemma-local");
